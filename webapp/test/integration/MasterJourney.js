sap.ui.define([
	...
	opaTest("MasterList Filtering on EMPRESAID less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("EMPRESAID").
	...
	opaTest("MasterList Filtering on EMPRESAID more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 ").
		and.iPressOKInViewSelectionDialog();
