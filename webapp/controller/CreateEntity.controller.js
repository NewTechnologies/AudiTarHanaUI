sap.ui.define([
	...
	return BaseController.extend("empresa.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Empresa", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Empresa", oData);
